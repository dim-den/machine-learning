...
print("lr.coef_: {}".format(lr.coef_)) # наклон
print("lr.intercept_: {}".format(lr.intercept_)) # сдвиг
...
ridge = Ridge().fit(X_train, y_train) # boston housing
print("Правильность на обучающем наборе (alpha=1): {:.2f}".format(ridge.score(X_train, y_train)))
print("Правильность на тестовом наборе (alpha=1): {:.2f}".format(ridge.score(X_test, y_test)))

ridge10 = Ridge(alpha=10).fit(X_train, y_train)
print("Правильность на обучающем наборе (alpha=10): {:.2f}".format(ridge10.score(X_train, y_train)))
print("Правильность на тестовом наборе (alpha=10): {:.2f}".format(ridge10.score(X_test, y_test)))

ridge01 = Ridge(alpha=0.1).fit(X_train, y_train)
print("Правильность на обучающем наборе (alpha=0.1): {:.2f}".format(ridge01.score(X_train, y_train)))
print("Правильность на тестовом наборе (alpha=0.1): {:.2f}".format(ridge01.score(X_test, y_test)))

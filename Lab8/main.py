...
print("Правильность на обучающемнаборе:{:.3f}".format(tree.score(X_train, y_train)))
print("Правильность на тестовомнаборе:{:.3f}".format(tree.score(X_test, y_test)))
...
export_graphviz(tree, out_file="C:/Users/dimde/OneDrive/Рабочий стол/Интеллектуальный анализ данных/Lab8/tree.dot", class_names=["malignant", "benign"],
                                                     feature_names=cancer.feature_names, impurity=False, filled=True)
import graphviz

with open("C:/Users/dimde/OneDrive/Рабочий стол/Интеллектуальный анализ данных/Lab8/tree.dot") as f:
   dot_graph = f.read()
...
import pandas as pd
ram_prices = pd.read_csv("C:/Users/dimde/OneDrive/Рабочий стол/Интеллектуальный анализ данных/Lab8/ram_price.csv")
